...
import { Bird, Menu, SquaresUnite, X } from "lucide-react";
      ...
      <nav className="container mx-auto max-w-7xl  flex items-center justify-between">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Button
            variant="outline"
            size="sm"
            className="h-10 shadow-none font-medium py-2.5 text-sm rounded-full w-20 "
          >
            Login
          </Button>
          <Button
            variant="default"
            size="sm"
            className="h-10 py-2.5 shadow-none font-medium text-sm rounded-full w-20  "
          >
            Hire
          </Button>
        </div>
