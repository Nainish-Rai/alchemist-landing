                  ...
                  <div className="relative w-full">
                    <FormControl>
                      <Input
                        ...
                        className="block h-fit w-full rounded-lg bg-background py-5 pr-5 pl-11 text-primary"
                      />
                    </FormControl>
...
const HeroSection = () => {
  return (
    <section className="font-dm_sans bg-background py-12 md:py-8 max-w-7xl mx-auto">
          ...
          <div>
            <div className="flex max-w-[40.625rem] flex-col gap-8">
              ...
              <p className="text-lg text-balance text-muted-foreground">
                Alchemist uses a precise, data-driven approach to connect you
                with exceptional candidates who not only meet the requirements
          ...
          <div>
            <div className="relative mx-auto aspect-[0.990343348/1] w-full max-w-[42.5rem]">
              <div className="absolute top-[5.04%] left-[4.33%] z-20 w-[42.25%]">
                ...
                >
                  <img
                    src="https://cdn.cosmos.so/3ee6b2c0-b35c-41c3-a31d-637e8e4b9cc8?format=jpeg"
                    alt=""
              ...
              <div className="absolute right-[8.23%] bottom-[12.87%] z-20 w-[42.25%]">
                ...
                >
                  <img
                    src="https://cdn.cosmos.so/ec4f758a-7998-4baa-87e5-4e8e5a33fab7?format=jpeg"
                    alt=""
                    className="block size-full object-cover"
                  />
                </AspectRatio>
              ...
              <div className="absolute bottom-[5%] left-[10.94%] z-30 w-[42.25%]">
                ...
                >
                  <img
                    src="https://cdn.cosmos.so/53f510b2-14fd-4b3f-8419-27aa8797f821?format=jpeg"
                    alt=""
                    className="block size-full object-cover"
                  />
                </AspectRatio>
              ...
              <Star className="absolute top-[15%] right-[16%] size-[4%] stroke-[#D64E29]" />
              <svg
